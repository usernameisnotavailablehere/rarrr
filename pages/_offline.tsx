  ...
  return (
    <div className={styles.main}>
      <Head>
        ...
        <title> Website for people who dont care about school - Offline</title>
      ...
      <main className={styles.main}>
        ...
        <div id={styles['main-page-content']}>
          ...
          <div id={styles["main-page-init"]}>
            <h1 className={styles["main-title"]}><span>Website for people who dont care about school</span> <FaGithub style={{"cursor": "pointer"}} onClick={(e) => {window.open('https://github.com/usernameisnotavailablehere');}} /></h1>
